...
lessThan8:
    ...
    .for (var char=0; char<40;char++) {
        sta Configuration.Charset1Address + char * 8
    }

    eor #$ff
    .for (var char=0; char<40;char++) {
        sta Configuration.Charset2Address + char * 8
    }
    jmp charLoop1
...
.segment Default "SpeedCode Copyloop"

charLoop1:
    .for (var char=0;char<40;char++) {
    lda Configuration.Charset1Address + char * 8
    .for (var byte=0; byte < 7;byte++) {
        sta Configuration.Charset1Address + char*8 + byte
    }
    }

charLoop2:
    .for (var char=0;char<40;char++) {
    lda Configuration.Charset2Address + char * 8
    .for (var byte=0; byte < 7;byte++) {
        sta Configuration.Charset2Address + char*8 + byte
    }
    }
