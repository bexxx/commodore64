...
fadeColors:                                     // red grey tones only, mgmt wants special color scheme
                                                // index with current color gets the next fade color
                                                // fading to white here
    .byte 9, WHITE, DARK_GREY, WHITE, WHITE, WHITE, WHITE, WHITE, WHITE, RED, LIGHT_GREY, GREY, LIGHT_RED, WHITE, WHITE, WHITE
